...
const Home = () => {
  ...
  useGSAP(() => {
    ...
    imageRefs.current.forEach((img) => {
      tl.set(imageRefs.current, { zIndex: 0 }, '+=0');
      tl.set(img, { zIndex: 1 }, '+=0');
      tl.to({}, { duration: 0.5 });
    });
  }, { scope: container });
  ...
  return (
    <div className="h-screen bg-neutral-900 text-neutral-200 px-8 relative overflow-hidden">
      ...
      <p className="uppercase text-[12rem] text-neutral-200 mix-blend-difference absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 z-30">adventure</p>
