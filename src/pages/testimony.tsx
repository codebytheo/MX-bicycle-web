    ...
    <div ref={container} className="bg-neutral-900 h-[120dvh] px-8 py-10 relative">
      <div className="grid grid-cols-2">
        <div className="w-full h-screen">
          <img ref={img1} src="/img/2.webp" alt="bicycle" loading="lazy" className="saturate-150" />
          <div className="mt-8">
        ...
        <div className="w-full place-content-end place-items-end">
          <img ref={img2} src="/img/8.webp" alt="bicycle" loading="lazy" className="w-3/4 saturate-150" />
